...
/**
 * NewsSeorch represents the model behind the search form of `common\models\News`.
 */
class NewsSeorch extends News
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['title_cyrl', 'title_en', 'title_ru', 'title_uz', 'desc_cyrl', 'desc_en', 'desc_ru', 'desc_uz', 'content_cyrl', 'content_en', 'content_ru', 'content_uz', 'image', 'date', 'author_uz', 'author_ru', 'author_en', 'author_cyrl'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'title_cyrl', $this->title_cyrl])
            ...
            ->andFilterWhere(['like', 'author_uz', $this->author_uz])
            ->andFilterWhere(['like', 'author_ru', $this->author_ru])
            ->andFilterWhere(['like', 'author_en', $this->author_en])
            ->andFilterWhere(['like', 'author_cyrl', $this->author_cyrl]);
