...
class NewsSearch extends News
{
    ...
    public function rules()
    {
        return [
            ...
            [['title_cyrl', 'title_en', 'title_ru', 'title_uz', 'desc_cyrl', 'desc_en', 'desc_ru', 'desc_uz', 'content_cyrl', 'content_en', 'content_ru', 'content_uz', 'image', 'date', 'author_uz', 'author_ru', 'author_en'], 'safe'],
        ];
    }
