...
if (!tech || tech == 1){
    $( ".prev  span" ).first().remove();
    $('.prev').append('<a><span>«</span></a>');
}

// $( ".disabled" ).addClass( "pagginetion" );
// $( ".prev" ).removeClass( "pagginetion" );
//
// $( ".pagginetion  span" ).first().remove();
// $('.pagginetion').append('<a><span>...</span></a>');
...
+function ($) { "use strict";
    ...
    Zoom.prototype._zoomOriginal = function () {
        ...
        this._targetImageWrap.className = 'zoom-img-wrap imgss'
    ...
    Zoom.prototype._triggerAnimation = function () {
        ...
        var targetTransform = 'scale(' +  ')'
        var imageWrapTransform = 'translate('  + ')'
    ...
    t.fn.counterUp = function (e) {
        ...
        return this.each(function () {
            var e = t(this),
                ...
                u = function () {
                    var t = [], u = r.time / r.delay, o = e.text(), i = /[0-9]+,[0-9]+/.test(o);
                    o = o.replace(/,/g, "");
                    var c = (o.split(".")[1] || []).length, s = /[0-9]+:[0-9]+:[0-9]+/.test(o);
                    if (s) {
                        var l = o.split(":"), f = 1;
                    ...
                    for (var d = u; d >= 1; d--) {
                        ...
                        if (s) {
                            p = parseInt(a / u * d);
                            var m = parseInt(p / 3600) % 24, h = parseInt(p / 60) % 60, y = parseInt(p % 60, 10);
...
!function (t) {
    ...
    var t = -1, e = -1, o = function (t) {
        return parseFloat(t) || 0
    }, a = function (t) {
        var e = 1, a = $(t), n = null, i = [];
        return a.each(function () {
            var t = $(this), a = t.offset().top - o(t.css("margin-top")), r = i.length > 0 ? i[i.length - 1] : null;
            null === r ? i.push(t) : Math.floor(Math.abs(n - a)) <= e ? i[i.length - 1] = r.add(t) : i.push(t), n = a
        }), i
    }, n = function (t) {
    ...
    }, i = $.fn.matchHeight = function (t) {
        var e = n(t);
        if (e.remove) {
            var o = this;
            return this.css(e.property, ""), $.each(i._groups, function (t, e) {
                e.elements = e.elements.not(o)
            }), this
        }
        return this.length <= 1 && !e.target ? this : (i._groups.push({
            elements: this,
            options: e
        }), i._apply(this, e), this)
    };
    i.version = "master", i._groups = [], i._throttle = 80, i._maintainScroll = !1, i._beforeUpdate = null, i._afterUpdate = null, i._rows = a, i._parse = o, i._parseOptions = n, i._apply = function (t, e) {
        var r = n(e), s = $(t), h = [s], l = $(window).scrollTop(), c = $("html").outerHeight(!0),
            p = s.parents().filter(":hidden");
        return p.each(function () {
            var t = $(this);
            t.data("style-cache", t.attr("style"))
        }), p.css("display", "block"), r.byRow && !r.target && (s.each(function () {
            ...
            if (r.target) n = r.target.outerHeight(!1); else {
                ...
                a.each(function () {
                    var t = $(this), e = t.attr("style"), o = t.css("display");
            ...
            a.each(function () {
                var t = $(this), e = 0;
                r.target && t.is(r.target) || ("border-box" !== t.css("box-sizing") && (e += o(t.css("border-top-width")) + o(t.css("border-bottom-width")), e += o(t.css("padding-top")) + o(t.css("padding-bottom"))), t.css(r.property, n - e + "px"))
            })
        }), p.each(function () {
            var t = $(this);
            t.attr("style", t.data("style-cache") || null)
        }), i._maintainScroll && $(window).scrollTop(l / c * $("html").outerHeight(!0)), this
    }, i._applyDataApi = function () {
        var t = {};
        $("[data-match-height], [data-mh]").each(function () {
            var e = $(this), o = e.attr("data-mh") || e.attr("data-match-height");
            o in t ? t[o] = t[o].add(e) : t[o] = e
        }), $.each(t, function () {
            this.matchHeight(!0)
        })
    };
    var r = function (t) {
        i._beforeUpdate && i._beforeUpdate(t, i._groups), $.each(i._groups, function () {
            i._apply(this.elements, this.options)
        }), i._afterUpdate && i._afterUpdate(t, i._groups)
    };
    i._update = function (o, a) {
        if (a && "resize" === a.type) {
            var n = $(window).width();
            if (n === t) return;
            t = n
        }
        o ? -1 === e && (e = setTimeout(function () {
            r(a), e = -1
        }, i._throttle)) : r(a)
    }, $(i._applyDataApi);
    var s = $.fn.on ? "on" : "bind";
    $(window)[s]("load", function (t) {
        i._update(!1, t)
    }), $(window)[s]("resize orientationchange", function (t) {
        i._update(!0, t)
    })
});
