...
$this->title = Yii::t('app',"O'zbekiston fidoyisi");
$this->params['breadcrumbs'][] = Yii::t('app',"O'zbekiston fidoyisi");
$this->params['titlebreadcrumbs'] = Yii::t('app',"O'zbekiston fidoyisi");
        ...
        foreach ($news as $item): ?>
            ...
            <div class="column">
                ...
                <div class="news-box">
                    ...
                    <div class="new-txt" style="height: 274px">
                        ...
                        <h6>
                            <a class="sansserif" style="font-size: 16px" href="<?=\yii\helpers\Url::to(["/committee/digesta?id=$item->id"], true)?>"><?= \yii\helpers\StringHelper::truncate($item->{'title_' . $lang}, 90,' ...' )?></a>
                        </h6>
                        <p class="sansserif"> <?= \yii\helpers\StringHelper::truncate($item->{'desc_' . $lang}, 97,' ...' )?> </p>
                    </div>
