...
if ($exception->statusCode == 404){
    $this->params['titlebreadcrumbs'] =  Yii::t('app', "Kechirasiz! Siz izlayotgan sahifa mavjud emas.");
}else{
    $this->params['titlebreadcrumbs'] = $exception->statusCode.' '.$exception->getMessage();
}
?>
    ...
    <div class="container-floud">
        <div class="col-xs-12 ground-color text-center">
            <div class="container-error-404">
                ...
                <div class="msg"><?php echo Yii::t('app', "Xato"); ?><span class="triangle"></span></div>
            </div>
<!--            <h2 class="h1">--><?php //echo Yii::t('app', "Kechirasiz! Siz izlayotgan sahifa mavjud emas."); ?><!--</h2>-->
        </div>
    </div>
</div>
<?php else:?>
